...
export interface ApiContext<Definitions extends qt.EndpointDefinitions> {
  ...
  batch(cb: () => void): void
  extractRehydrationInfo: (action: qt.AnyAction) => qt.CombinedState<any, any, any> | undefined
...
export type Module<Name extends ModuleName> = {
  ...
  init<BaseQuery extends qt.BaseQueryFn, Definitions extends qt.EndpointDefinitions, ReducerPath extends string, TagTypes extends string>(
    ...
    injectEndpoint(endpointName: string, definition: qt.EndpointDefinition<any, any, any, any>): void
  }
}
...
> = qt.UnionToIntersection<ApiModules<BaseQuery, Definitions, ReducerPath, TagTypes>[Enhancers]> & {
  injectEndpoints<NewDefinitions extends qt.EndpointDefinitions>(_: {
    endpoints: (build: qt.EndpointBuilder<BaseQuery, TagTypes, ReducerPath>) => NewDefinitions
  ...
  enhanceEndpoints<NewTagTypes extends string = never>(_: {
    ...
    endpoints?: qt.ReplaceTagTypes<Definitions, TagTypes | qt.NoInfer<NewTagTypes>> extends infer NewDefinitions
      ? {
...
export interface ApiModules<BaseQuery extends qt.BaseQueryFn, Definitions extends qt.EndpointDefinitions, ReducerPath extends string, TagTypes extends string> {
  [reactHooksModuleName]: {
    ...
    ): (arg: qt.QueryArgFrom<Definitions[EndpointName]>, options?: PrefetchOptions) => void
  ...
  [coreModuleName]: {
    ...
    util: {
      ...
      ): qt.QueryActionCreatorResult<Definitions[EndpointName] & { type: "query" }> | undefined
      getRunningOperationPromise<EndpointName extends qt.MutationKeys<Definitions>>(
        endpointName: EndpointName,
        fixedCacheKeyOrRequestId: string
      ): qt.MutationActionCreatorResult<Definitions[EndpointName] & { type: "mutation" }> | undefined
      ...
      updateQueryData: UpdateQueryDataThunk<Definitions, qt.RootState<Definitions, string, ReducerPath>>
      /** @deprecated renamed to `updateQueryData` */
      updateQueryResult: UpdateQueryDataThunk<Definitions, qt.RootState<Definitions, string, ReducerPath>>
      patchQueryData: PatchQueryDataThunk<Definitions, qt.RootState<Definitions, string, ReducerPath>>
      /** @deprecated renamed to `patchQueryData` */
      patchQueryResult: PatchQueryDataThunk<Definitions, qt.RootState<Definitions, string, ReducerPath>>
      resetApiState: SliceActions["resetApiState"]
      invalidateTags: qt.ActionCreatorWithPayload<Array<qt.TagDescription<TagTypes>>, string>
      selectInvalidatedBy: (
