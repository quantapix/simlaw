...
describe("getIn", () => {
  ...
  it("deep get throws without list or array-like", () => {
    // @ts-expect-error
    expect(() => Map().getIn(undefined)).toThrow("Invalid keyPath: expected Ordered Collection or Array: undefined")
    // @ts-expect-error
    ...
    expect(() => Map().getIn("abc")).toThrow("Invalid keyPath: expected Ordered Collection or Array: abc")
    // TODO: should expect error
    expect(() => getIn(Map(), "abc")).toThrow("Invalid keyPath: expected Ordered Collection or Array: abc")
  })
