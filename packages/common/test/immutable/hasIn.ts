...
describe("hasIn", () => {
  ...
  it("deep has throws without list or array-like", () => {
    // @ts-expect-error
    expect(() => Map().hasIn(undefined)).toThrow("Invalid keyPath: expected Ordered Collection or Array: undefined")
    // @ts-expect-error
    ...
    expect(() => Map().hasIn("abc")).toThrow("Invalid keyPath: expected Ordered Collection or Array: abc")
    // TODO: should expect error
    expect(() => hasIn(Map(), "abc")).toThrow("Invalid keyPath: expected Ordered Collection or Array: abc")
  })
