...
describe("slice", () => {
  ...
  it("slices a sparse indexed sequence", () => {
    expect(Seq([1, undefined, 2, undefined, 3, undefined, 4, undefined, 5, undefined, 6]).slice(1).toArray()).toEqual([
      undefined,
      2,
      undefined,
      3,
    ...
    expect(Seq([1, undefined, 2, undefined, 3, undefined, 4, undefined, 5, undefined, 6]).slice(2).toArray()).toEqual([
      2,
      undefined,
      3,
      undefined,
    ...
    expect(
      Seq([1, undefined, 2, undefined, 3, undefined, 4, undefined, 5, undefined, 6]).slice(3, -3).toArray()
