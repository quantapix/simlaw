...
describe("createAction", () => {
  ...
  describe("actionCreator.match", () => {
    it("should return true for actions generated by own actionCreator", () => {
...
describe("createReducer", () => {
  ...
  describe("actionMatchers argument", () => {
    ...
    it("runs reducer cases followed by all matching actionMatchers", () => {
      const reducer = qx.createReducer(
        initialState,
        {
    ...
    it("works with `actionCreator.match`", () => {
      const reducer = qx.createReducer(initialState, {}, [
        {
  ...
  describe("alternative builder callback for actionMap", () => {
    ...
    it("can be used with ActionCreators", () => {
    ...
    it("can be used with ActionCreators and string types combined", () => {
      const reducer = qx.createReducer(0, builder =>
        builder
          .addCase(increment, (state, action) => state + action.payload)
          .addCase(
    ...
    it("will throw if the same type is used twice", () => {
      expect(() =>
...
describe("createSlice", () => {
  ...
  describe("when passing extra reducers", () => {
    ...
    describe("alternative builder callback for extraReducers", () => {
      ...
      it("can be used with string action types", () => {
        const slice = qx.createSlice({
          name: "counter",
          initialState: 0,
          reducers: {},
      ...
      it("prevents the same action type from being specified twice", () => {
        expect(() => {
          const slice = qx.createSlice({
            name: "counter",
            initialState: 0,
      ...
      it("can be used with addDefaultCase", () => {
        const slice = qx.createSlice({
          name: "counter",
          initialState: 0,
          reducers: {},
  ...
  describe("circularity", () => {
    it("extraReducers can reference each other circularly", () => {
...
describe("configureStore", () => {
  jest.spyOn(qx, "applyMiddleware")
  jest.spyOn(qx, "combineReducers")
  jest.spyOn(qx, "compose")
  jest.spyOn(qx, "createStore")
  jest.spyOn(qx, "composeWithDevTools") // @remap-prod-remove-line
  const reducer: qx.Reducer = (state = {}, _action) => state
