...
describe("Ratio", () => {
  test("should contain `ratio-1x1` and custom class", () => {
  ...
  test("should support custom ratios using percent for aspectRatio", () => {
    const { getByTestId } = render(
  ...
  test("should support custom ratios using fraction for aspectRatio", () => {
    const { getByTestId } = render(
  ...
  test("should support use 100% as custom ratio if aspectRatio is less than 0", () => {
    const { getByTestId } = render(
  ...
  test("should support use 100% as custom ratio if aspectRatio is greater than 100", () => {
    const { getByTestId } = render(
