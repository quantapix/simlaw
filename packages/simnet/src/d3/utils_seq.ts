...
export function bin(): qt.HistoNumGen<number, number>
export function bin<T, V extends number | undefined>(): qt.HistoNumGen<T, V>
export function bin<T, V extends Date | undefined>(): qt.HistoDateGen<T, V>
export function bin() {
