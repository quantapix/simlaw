...
export namespace clone {
  export function lib(this: qg.Gdata, g: qg.Mgraph, n: qg.Noper, lib: qg.Nmeta, old: string, pre: string) {
  ...
  function helper(
    ...
    _.each(lib.meta!.nodes(), nn => {
      ...
      switch (o.type) {
        case qt.NdataT.META:
          const n2 = helper.call(this, g, old, o as qg.Nmeta, oldPre, pre, dict)
          n2.parent = n
  ...
  function add(this: qg.Gdata, m: qg.Nmeta, fnName: string, node: qg.Noper, pre: string): qg.Noper {
  ...
  export function edges(this: qg.Gdata, nd: qg.Nmeta, _md: qg.Nmeta, old: string, pre: string) {
    const meta = nd.meta!
