...
export class Nclus extends qn.Ndata implements qg.Nclus {
  ...
  constructor(t: qt.NdataT, n: string, public meta?: qg.Mgraph, opts?: qg.Opts) {
    super(t, n)
    opts = opts ?? ({ isCompound: true } as qg.Opts)
    this.core = qg.createGraph<qg.Gdata, qg.Ndata, qg.Edata>(qt.GdataT.CORE, n, opts)
  }
  ...
  build(sel: qt.Sel, e: qs.Elem, c = qt.Class.Scene.GROUP) {
    ...
    if (empty) {
      s.attr("opacity", 0).transition().attr("opacity", 1)
    }
    return s
  }
}
...
export class Nmeta extends Nclus implements qg.Nmeta {
  ...
  constructor(n: string, o = {} as qg.Opts) {
    super(qt.NdataT.META, n, qg.createGraph<qg.Gdata, Ncomb, qg.Edata>(qt.GdataT.META, n, o), o)
  }
...
export class Nlist extends Nclus implements qg.Nlist {
  ...
  constructor(
    ...
    super(qt.NdataT.LIST, n, qg.createGraph<qg.Gdata, Ncomb, qg.Edata>(qt.GdataT.LIST, n, o), o)
  }
}
