...
const allEdges: Stylesheet = {
  ...
  style: {
    ...
    "line-color": selectValueByThemeDynamic(NrwlPalette.gray, NrwlPalette.black),
    ...
    "target-arrow-color": selectValueByThemeDynamic(NrwlPalette.gray, NrwlPalette.black),
  },
}
...
export const edgeStyles: Stylesheet[] = [allEdges, affectedEdges, implicitEdges, dynamicEdges, transparentEdges]
