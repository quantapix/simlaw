...
const allNodes: Stylesheet = {
  ...
  style: {
    ...
    "font-family": FONTS,
    "border-style": "solid",
    "border-color": selectValueByThemeDynamic(NrwlPalette.gray, NrwlPalette.darkGray),
    ...
    backgroundColor: selectValueByThemeDynamic(NrwlPalette.black, NrwlPalette.white),
