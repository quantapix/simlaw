...
it("arc().innerRadius(f)(…) propagates the context and arguments to the specified function f", () => {
  ...
  arc()
    .innerRadius(function () {
      actual = { that: this, args: [].slice.call(arguments) }
    })
...
it("arc().centroid(…) computes the midpoint of the center line of the arc", () => {
  ...
  assert.deepStrictEqual(
    a.centroid({ innerRadius: 0, outerRadius: 100, startAngle: 0, endAngle: Math.PI }).map(round),
    [50, 0]
  )
  assert.deepStrictEqual(
    a.centroid({ innerRadius: 0, outerRadius: 100, startAngle: 0, endAngle: Math.PI / 2 }).map(round),
    [35.355339, -35.355339]
  )
  assert.deepStrictEqual(
    a.centroid({ innerRadius: 50, outerRadius: 100, startAngle: 0, endAngle: -Math.PI }).map(round),
    [-75, -0]
  )
  assert.deepStrictEqual(
    a.centroid({ innerRadius: 50, outerRadius: 100, startAngle: 0, endAngle: -Math.PI / 2 }).map(round),
    [-53.033009, -53.033009]
  )
})
...
it("arc().innerRadius(f).centroid(…) propagates the context and arguments to the specified function f", () => {
  ...
  arc()
    ...
    .centroid.apply(expected.that, expected.args)
  assert.deepStrictEqual(actual, expected)
})
...
it("areaRadial() returns a default radial area shape", () => {
  ...
  assertPathEqual(
    ...
    "M0,-1L2.727892,1.248441L-3.784012,3.268218L0,0L0,0L0,0Z"
  )
})
...
it("lineRadial() returns a default radial line shape", () => {
  ...
  assertPathEqual(
    ...
    "M0,-1L2.727892,1.248441L-3.784012,3.268218"
  )
})
import assert from "assert"
...
it("link.source(f)(..args) passes arguments to the specified function f", () => {
  ...
  const actual = []
  link(curveLinear).source(function (d) {
    actual.push([].slice.call(arguments))
    return d
  })(data, extra)
...
it("link.target(f)(..args) passes source and arguments to the specified function f", () => {
  ...
  const extra = { name: "extra" }
  const actual = []
  link(curveLinear).target(function (d) {
    actual.push([].slice.call(arguments))
    return d
  })(data, extra)
  assert.deepStrictEqual(actual, [[data, extra]])
...
it("pie(data) returns arcs in input order", () => {
  ...
  assert.deepStrictEqual(p([1, 3, 2]), [
    ...
    { data: 3, value: 3, index: 0, startAngle: 0.0, endAngle: 3.141592653589793, padAngle: 0 },
...
it("pie(data) coerces the specified value to a number", () => {
  ...
  assert.deepStrictEqual(p(["1", three, "2"]), [
    { data: "1", value: 1, index: 2, startAngle: 5.235987755982988, endAngle: 6.283185307179585, padAngle: 0 },
    { data: three, value: 3, index: 0, startAngle: 0.0, endAngle: 3.141592653589793, padAngle: 0 },
    { data: "2", value: 2, index: 1, startAngle: 3.141592653589793, endAngle: 5.235987755982988, padAngle: 0 },
  ])
})
...
it("pie(data) treats negative values as zero", () => {
  ...
  assert.deepStrictEqual(p([1, 0, -1]), [
    { data: 1, value: 1, index: 0, startAngle: 0.0, endAngle: 6.283185307179586, padAngle: 0 },
...
it("pie(data) treats NaN values as zero", () => {
  ...
  actual[1].data = actual[1].value = actual[2].value = expected[1].data = expected[1].value = expected[2].value = {} // deepEqual NaN
  assert.deepStrictEqual(actual, expected)
})
...
it("pie(data) restricts |endAngle - startAngle| to τ", () => {
  ...
  assert.deepStrictEqual(p.startAngle(0).endAngle(7)([1, 2]), [
    { data: 1, value: 1, index: 1, startAngle: 4.1887902047863905, endAngle: 6.283185307179586, padAngle: 0 },
    { data: 2, value: 2, index: 0, startAngle: 0.0, endAngle: 4.1887902047863905, padAngle: 0 },
  ])
  assert.deepStrictEqual(p.startAngle(7).endAngle(0)([1, 2]), [
    ...
    { data: 2, value: 2, index: 0, startAngle: 7.0, endAngle: 2.8112097952136095, padAngle: 0 },
  ])
  assert.deepStrictEqual(p.startAngle(1).endAngle(8)([1, 2]), [
    { data: 1, value: 1, index: 1, startAngle: 5.1887902047863905, endAngle: 7.283185307179586, padAngle: 0 },
    { data: 2, value: 2, index: 0, startAngle: 1.0, endAngle: 5.1887902047863905, padAngle: 0 },
  ])
  assert.deepStrictEqual(p.startAngle(8).endAngle(1)([1, 2]), [
    ...
    { data: 2, value: 2, index: 0, startAngle: 8.0, endAngle: 3.8112097952136095, padAngle: 0 },
  ])
})
...
it("pie.value(value)(data) observes the specified value function", () => {
  assert.deepStrictEqual(
    ...
    [
      { data: undefined, value: 0, index: 2, startAngle: 6.283185307179586, endAngle: 6.283185307179586, padAngle: 0 },
      { data: undefined, value: 1, index: 1, startAngle: 4.1887902047863905, endAngle: 6.283185307179586, padAngle: 0 },
      { data: undefined, value: 2, index: 0, startAngle: 0.0, endAngle: 4.1887902047863905, padAngle: 0 },
    ]
  )
})
...
it("pie().startAngle(θ)(data) observes the specified start angle", () => {
  assert.deepStrictEqual(pie().startAngle(Math.PI)([1, 2, 3]), [
    ...
    { data: 2, value: 2, index: 1, startAngle: 4.71238898038469, endAngle: 5.759586531581287, padAngle: 0 },
    { data: 3, value: 3, index: 0, startAngle: 3.141592653589793, endAngle: 4.71238898038469, padAngle: 0 },
  ])
})

it("pie().endAngle(θ)(data) observes the specified end angle", () => {
  assert.deepStrictEqual(pie().endAngle(Math.PI)([1, 2, 3]), [
    { data: 1, value: 1, index: 2, startAngle: 2.617993877991494, endAngle: 3.1415926535897927, padAngle: 0 },
    { data: 2, value: 2, index: 1, startAngle: 1.5707963267948966, endAngle: 2.617993877991494, padAngle: 0 },
    { data: 3, value: 3, index: 0, startAngle: 0.0, endAngle: 1.5707963267948966, padAngle: 0 },
  ])
})

it("pie().padAngle(δ)(data) observes the specified pad angle", () => {
  assert.deepStrictEqual(pie().padAngle(0.1)([1, 2, 3]), [
    { data: 1, value: 1, index: 2, startAngle: 5.185987755982988, endAngle: 6.283185307179585, padAngle: 0.1 },
    { data: 2, value: 2, index: 1, startAngle: 3.0915926535897933, endAngle: 5.185987755982988, padAngle: 0.1 },
    { data: 3, value: 3, index: 0, startAngle: 0.0, endAngle: 3.0915926535897933, padAngle: 0.1 },
  ])
})
...
it("pie().startAngle(θ₀).endAngle(θ₁).padAngle(δ)(data) restricts the pad angle to |θ₁ - θ₀| / data.length", () => {
  assert.deepStrictEqual(pie().startAngle(0).endAngle(Math.PI).padAngle(Infinity)([1, 2, 3]), [
    ...
    { data: 3, value: 3, index: 0, startAngle: 0.0, endAngle: 1.0471975511965976, padAngle: 1.0471975511965976 },
  ])
  assert.deepStrictEqual(pie().startAngle(0).endAngle(-Math.PI).padAngle(Infinity)([1, 2, 3]), [
    {
      data: 1,
...
it("pie.sortValues(f) sorts arcs by value per the specified comparator function f", () => {
  const p = pie()
  assert.deepStrictEqual(
    p.sortValues(function (a, b) {
      return a - b
    })([1, 3, 2]),
    [
      { data: 1, value: 1, index: 0, startAngle: 0.0, endAngle: 1.0471975511965976, padAngle: 0 },
      { data: 3, value: 3, index: 2, startAngle: 3.141592653589793, endAngle: 6.283185307179586, padAngle: 0 },
      { data: 2, value: 2, index: 1, startAngle: 1.0471975511965976, endAngle: 3.141592653589793, padAngle: 0 },
    ]
  )
  assert.deepStrictEqual(
    p.sortValues(function (a, b) {
...
it("pie.sort(f) sorts arcs by data per the specified comparator function f", () => {
  ...
  assert.deepStrictEqual(
    ...
    [
      { data: a, value: 1, index: 0, startAngle: 0.0, endAngle: 1.0471975511965976, padAngle: 0 },
      { data: c, value: 3, index: 2, startAngle: 3.141592653589793, endAngle: 6.283185307179586, padAngle: 0 },
      { data: b, value: 2, index: 1, startAngle: 1.0471975511965976, endAngle: 3.141592653589793, padAngle: 0 },
    ]
  )
  assert.deepStrictEqual(
    p.sort(function (a, b) {
    ...
    [
      { data: a, value: 1, index: 2, startAngle: 5.235987755982988, endAngle: 6.283185307179585, padAngle: 0 },
      { data: c, value: 3, index: 0, startAngle: 0.0, endAngle: 3.141592653589793, padAngle: 0 },
      { data: b, value: 2, index: 1, startAngle: 3.141592653589793, endAngle: 5.235987755982988, padAngle: 0 },
    ]
  )
...
it("symbol.type(symbolCross) generates a polygon with the specified size", () => {
  const p = polygonContext(),
    s = symbol().type(symbolCross).context(p)
  s.size(1)()
  assertInDelta(p.area(), 1)
  s.size(240)()
  assertInDelta(p.area(), 240)
})
...
it("symbol.type(symbolDiamond) generates a polygon with the specified size", () => {
  const p = polygonContext(),
    s = symbol().type(symbolDiamond).context(p)
  s.size(1)()
  assertInDelta(p.area(), 1)
  s.size(240)()
  assertInDelta(p.area(), 240)
...
it("symbol.type(symbolStar) generates a polygon with the specified size", () => {
  const p = polygonContext(),
    s = symbol().type(symbolStar).context(p)
  s.size(1)()
  assertInDelta(p.area(), 1)
  s.size(240)()
  assertInDelta(p.area(), 240)
...
it("symbol.type(symbolSquare) generates a polygon with the specified size", () => {
  const p = polygonContext(),
    s = symbol().type(symbolSquare).context(p)
  s.size(1)()
  assertInDelta(p.area(), 1)
  s.size(240)()
  assertInDelta(p.area(), 240)
...
it("symbol.type(symbolTriangle) generates a polygon with the specified size", () => {
  const p = polygonContext(),
    s = symbol().type(symbolTriangle).context(p)
  s.size(1)()
  assertInDelta(p.area(), 1)
  s.size(240)()
  assertInDelta(p.area(), 240)
...
it("symbol.type(symbolWye) generates a polygon with the specified size", () => {
  const p = polygonContext(),
    s = symbol().type(symbolWye).context(p)
  s.size(1)()
  assertInDelta(p.area(), 1)
  s.size(240)()
  assertInDelta(p.area(), 240)
