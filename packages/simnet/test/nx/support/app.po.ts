...
export const getGroupByFolderCheckbox = () => cy.get("input[name=displayOptions][value=groupByFolder]")

export const getSearchDepthCheckbox = () => cy.get("input[name=depthFilter][value=depthFilterActivated]")
...
export const getSearchDepthDecrementButton = () => cy.get("[data-cy=decrement-depth-filter]")
export const getSearchDepthIncrementButton = () => cy.get("[data-cy=increment-depth-filter]")

export const getIncludeProjectsInPathButton = () => cy.get("input[name=textFilterCheckbox]")

export const getImageDownloadButton = () => cy.get("[data-cy=downloadImageButton]")

export const getFocusButtonForProject = (projectName: string) => cy.get(`[data-cy="focus-button-${projectName}"]`)
