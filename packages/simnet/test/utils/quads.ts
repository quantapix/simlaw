...
tape("quadtree.addAll(data) computes the extent of the data before adding", function (test) {
  var q = d3_quadtree.quadtree().addAll([
    [0.4, 0.4],
    [0, 0],
    [0.9, 0.9],
  ])
...
tape("quadtree.copy() returns a copy of this quadtree", function (test) {
  var q0 = d3_quadtree.quadtree().addAll([
    [0, 0],
    [1, 0],
    [0, 1],
    [1, 1],
...
tape("quadtree.copy() isolates changes to the extent", function (test) {
  var q0 = d3_quadtree.quadtree().extent([
      [0, 0],
      [1, 1],
    ]),
    q1 = q0.copy()
  q0.add([2, 2])
  test.deepEqual(q1.extent(), [
    [0, 0],
    [2, 2],
  ])
  q1.add([-1, -1])
  test.deepEqual(q0.extent(), [
    [0, 0],
    [4, 4],
  ])
  test.end()
...
tape("quadtree.cover(x, y) sets a trivial extent if the extent was undefined", function (test) {
  test.deepEqual(d3_quadtree.quadtree().cover(1, 2).extent(), [
    [1, 2],
    [2, 3],
  ])
  test.end()
...
tape(
  ...
  function (test) {
    test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(1, 2).extent(), [
      [0, 0],
      [4, 4],
    ])
    test.end()
...
tape("quadtree.cover(x, y) ignores invalid points", function (test) {
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(NaN, 2).extent(), [
    [0, 0],
    [1, 1],
  ])
  test.end()
...
tape("quadtree.cover(x, y) repeatedly doubles the existing extent if the extent was non-trivial", function (test) {
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(-1, -1).extent(), [
    [-4, -4],
    [4, 4],
  ])
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(1, -1).extent(), [
  ...
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(3, -1).extent(), [
    [0, -4],
    [8, 4],
  ])
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(3, 1).extent(), [
  ...
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(3, 3).extent(), [
    [0, 0],
    [4, 4],
  ])
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(1, 3).extent(), [
    [0, 0],
    [4, 4],
  ])
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(-1, 3).extent(), [
  ...
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(5, -3).extent(), [
    [0, -4],
    [8, 4],
  ])
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(5, 3).extent(), [
  ...
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(5, 5).extent(), [
    [0, 0],
    [8, 8],
  ])
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(3, 5).extent(), [
    [0, 0],
    [8, 8],
  ])
  test.deepEqual(d3_quadtree.quadtree().cover(0, 0).cover(2, 2).cover(-3, 5).extent(), [
...
tape("quadtree.extent() can be inferred by quadtree.cover", function (test) {
  var q = d3_quadtree.quadtree()
  test.deepEqual(q.cover(0, 0).extent(), [
    [0, 0],
    [1, 1],
  ])
  test.deepEqual(q.cover(2, 4).extent(), [
    [0, 0],
    [8, 8],
  ])
  test.end()
...
tape("quadtree.find(x, y) returns the closest point to the given [x, y]", function (test) {
  ...
  d3_array.range(dx * dy).forEach(function (i) {
    q.add([i % dx, (i / dx) | 0])
  })
